...
static char *const Usage = "taxonomy2tree <tax dump file(tab separated taxonomy dump)> <max tree level (<=0 to show all)> <write tree file here> <write tab separated summary here> [include empty nodes; 0 or 1; default 0)]\n";
